...
export class WSLayer extends Layer {
  ...
  connect() {
    ...
    this.ws = new WebSocket(this.uri + '/BeforeLogLineRead')
  ...
  _onmessage(e) {
    ...
    // ↑ those will be removed from upcoming version of FFXIV_ACT_Plugin.
      ...
      case 'AddCombatant': // initial event
        d.msg = d.msg || {}
        this.emit('logline', {
          type: 3,
          ts: Date.now(),
